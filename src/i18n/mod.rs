...
impl Translations {
    pub fn spanish() -> Self {
        Self {
            ...
            welcome_message: "Bienvenido! Esta es una herramienta de linea de comandos.",
            press_enter: "Pulsa ENTER para salir...",
            more_info: "Mas informacion:",

            cmd_init: "Inicializar configuracion",
            cmd_index: "Indexar un proyecto",
            cmd_search: "Buscar en archivos",
            cmd_stats: "Ver estadisticas",
            cmd_history: "Ver historial de busquedas",
            ...
            cache_saved: "Cache guardada en",
            cache_cleared: "Cache eliminada",
            ignore_pattern: "Ignorando patron",
            ext_filter: "Filtro por extensiones",

            search_text: "Busqueda por TEXTO",
            search_semantic: "Busqueda SEMANTICA (TF-IDF)",
            search_multithread: "Busqueda por TEXTO (multi-hilo)",
            query_label: "Query",
            ...
            time: "Tiempo",
            cores_used: "Nucleos usados",

            stats_title: "Estadisticas de semcode-search",
            files_indexed: "Archivos indexados",
            total_lines: "Total de lineas",
            languages: "Lenguajes",
            last_indexed: "Ultima indexacion",

            history_title: "Historial de busquedas",
            history_empty: "No hay busquedas en el historial",
            history_cleared: "Historial limpiado",
            history_total: "Total",
            last_search: "Ultima busqueda",

            alias_saved: "Alias guardado",
            alias_list: "Alias guardados",
            alias_empty: "No hay alias guardados",
            alias_removed: "Alias eliminado",
            alias_not_found: "Alias no encontrado",
            alias_running: "Ejecutando alias",

            error_cache_not_found: "No se encontro cache. Ejecute 'index' primero",
            error_cache_corrupted: "Cache corrupta. Ejecute 'index' primero",
            error_no_query: "Debes proporcionar una query con --query o un alias con --alias",
            error_config_exists: "Configuracion ya existe. Usa --force para sobreescribir",

            config_created: "Configuracion creada en",
            config_hint: "Puedes editarla manualmente o usar 'alias' para gestionar busquedas",

            watch_starting: "Observando cambios en",
            watch_interval: "Intervalo",
            watch_initial_index: "Indexando por primera vez...",
            watch_observing: "Observando",
            watch_changes: "cambios detectados",
    ...
    pub fn english() -> Self {
        Self {
            ...
            error_cache_not_found: "No cache found. Run 'index' first",
            error_cache_corrupted: "Corrupted cache. Run 'index' first",
            error_no_query: "You must provide a query with --query or an alias with --alias",
            error_config_exists: "Configuration already exists. Use --force to overwrite",

            config_created: "Configuration created at",
            config_hint: "You can edit it manually or use 'alias' to manage searches",

            watch_starting: "Watching changes in",
            watch_interval: "Interval",
            watch_initial_index: "Indexing for the first time...",
            watch_observing: "Watching",
            watch_changes: "changes detected",
...
pub fn get_all_translations(lang: Language) -> std::collections::HashMap<String, String> {
    ...
    map.insert(
        ...
        tr.search_semantic.to_string(),
    );
    map.insert(
        "search_multithread".to_string(),
        tr.search_multithread.to_string(),
    );
    ...
    map.insert(
        "history_cleared".to_string(),
        tr.history_cleared.to_string(),
    );
    ...
    map.insert(
        ...
        tr.alias_not_found.to_string(),
    );
    map.insert("alias_running".to_string(), tr.alias_running.to_string());

    map.insert(
        "error_cache_not_found".to_string(),
        tr.error_cache_not_found.to_string(),
    );
    map.insert(
        "error_cache_corrupted".to_string(),
        tr.error_cache_corrupted.to_string(),
    );
    map.insert("error_no_query".to_string(), tr.error_no_query.to_string());
    map.insert(
        "error_config_exists".to_string(),
        tr.error_config_exists.to_string(),
    );
    ...
    map.insert(
        "watch_initial_index".to_string(),
        tr.watch_initial_index.to_string(),
    );
    map.insert(
        "watch_observing".to_string(),
        tr.watch_observing.to_string(),
    );
    map.insert("watch_changes".to_string(), tr.watch_changes.to_string());
    map.insert(
        "watch_reindexing".to_string(),
        tr.watch_reindexing.to_string(),
    );
